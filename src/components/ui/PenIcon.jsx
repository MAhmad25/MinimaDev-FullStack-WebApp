...
const PenIcon = forwardRef(({ size = 18, color = "currentColor", strokeWidth = 2, className = "" }, ref) => {
      ...
      return (
            <motion.svg ref={scope} width={size} height={size} viewBox="0 0 32 32" fill="none" stroke={color} strokeWidth={strokeWidth} strokeLinecap="square" strokeMiterlimit="10" className={`cursor-pointer ${className}`} style={{ overflow: "visible" }} onHoverStart={start} onHoverEnd={stop}>
                  <motion.g
                        className="pen-group"
                        style={{
